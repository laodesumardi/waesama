<x-admin-layout>
    ...
    <!-- Welcome Section -->
    <div class="mb-8">
        <div class="rounded-lg shadow-sm p-6" style="background: linear-gradient(135deg, #003566 0%, #004080 100%);">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="{{ route('admin.citizens.create') }}" class="flex items-center p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 group">
                    ...
                    <div>
                        <p class="font-medium text-gray-900 group-hover:text-blue-700">Tambah Warga</p>
                        <p class="text-sm text-gray-500">Data baru</p>
                    </div>
                </a>
                
                <a href="{{ route('admin.service-requests.index') }}" class="flex items-center p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-orange-400 hover:bg-orange-50 transition-all duration-200 group">
                    ...
                    <div>
                        <p class="font-medium text-gray-900 group-hover:text-orange-700">Kelola Layanan</p>
                        <p class="text-sm text-gray-500">Permohonan</p>
                    </div>
                </a>
                
                <a href="{{ route('admin.documents.create') }}" class="flex items-center p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 group">
                    ...
                    <div>
                        <p class="font-medium text-gray-900 group-hover:text-blue-700">Upload Dokumen</p>
                        <p class="text-sm text-gray-500">File baru</p>
                    </div>
                </a>
                
                <a href="{{ route('admin.users') }}" class="flex items-center p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-green-400 hover:bg-green-50 transition-all duration-200 group">
                    ...
                    <div>
                        <p class="font-medium text-gray-900 group-hover:text-green-700">Kelola User</p>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="flex items-center justify-between p-4 rounded-lg" style="background-color: #f0fdf4;">
            ...
            <div class="flex items-center justify-between p-4 rounded-lg" style="background-color: #fff7ed;">
                <div class="flex items-center">
                    <div class="w-3 h-3 rounded-full bg-yellow-500 mr-3"></div>
                    <span class="font-medium text-gray-900">Backup</span>
                </div>
                <span class="text-sm font-medium text-yellow-600">Scheduled</span>
            </div>
        </div>
    </div>
</x-admin-layout>
